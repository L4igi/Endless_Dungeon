...
var maxNumberRooms = 25

enum BARRIERTYPE {DOOR = 0, ENEMY = 1, PUZZLE = 2}

enum INFLICTDAMAGEDURINGPHASE {PLAYER = 0, ENEMY = 1, PROJECTILE = 2, BLOCK = 3 }
...
enum ITEMTYPE{POTION = 0, KEY = 1, WEAPON = 2, HEARTCONTAINER = 3, FLASKCONTAINER = 4, PUZZLESWITCH=5}
